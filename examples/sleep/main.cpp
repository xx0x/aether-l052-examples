/**
 * @file main.cpp
 * @brief Sleep example for STM32L052
 * @details Simple program that flashes an LED three times,
 *          then enters Stop mode to save power.
 *          The system wakes up from Stop mode on a button press (PA0).
