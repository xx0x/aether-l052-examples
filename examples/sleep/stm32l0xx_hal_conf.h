/**
  ...
  * @author  STM32 Blink Example
  * @brief   HAL configuration file for STM32L052 blink example
  ******************************************************************************
  * @attention
  *
...
/* Enable only necessary modules for blink example */
...
/* UART FEATURE: Use to activate UART/USART feature inside HAL UART Driver
* Activated: UART code is present inside driver
* Deactivated: UART code cleaned from driver
*/

#define USE_UART_WAKEUP_SELECTION       1U
